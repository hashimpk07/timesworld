...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">  
        ...
        if( 1 == sizeFlag ){
            ...
            $.ajax({
                url:"<?php echo e(route('size.create')); ?>",
                type: "POST",
                dataType: "json",
                data:{ 
                    size:size,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\timesworld\resources\views/size/size-add.blade.php ENDPATH**/ ?>